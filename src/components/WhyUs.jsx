...
export default function WhyUs() {
  ...
  <div className="flex justify-center mt-10 text-4xl font-regular font-bold text-fuchsia-900">
    Why Us?
  </div>
    ...
    <div className="flex flex-wrap text-center justify-center">
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
          ...
          <h2 className="title-font font-regular text-2xl text-fuchsia-900 ">Latest Manufacturing Machinery</h2>
        </div>
      </div>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
          ...
          <h2 className="title-font font-regular text-2xl text-fuchsia-900">Reasonable Rates</h2>
        </div>
      </div>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
          ...
          <h2 className="title-font font-regular text-2xl text-fuchsia-900">Time Efficiency</h2>
        </div>
      </div>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
          ...
          <h2 className="title-font font-regular text-2xl text-fuchsia-900">Expertise in Industry</h2>
        </div>
      </div>
